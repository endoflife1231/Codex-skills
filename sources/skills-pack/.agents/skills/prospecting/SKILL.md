---
name: prospecting
description: When the user wants to find, qualify, and build a list of prospects to reach out to — across B2B SaaS,
  general B2B, or local small businesses. Also use when the user mentions "prospecting," "build a prospect list,"
  "find prospects," "find leads," "lead gen list," "find SaaS companies that," "find B2B companies," "find local
  businesses," "ICP-fit accounts," "who should we go after," "outbound list," "target account list," "find clients
  near me," "businesses without websites," "prospect research," or "qualified leads." Use this for the list-building
  and qualification phase. For writing the outbound copy after the list is built, see cold-email. For deep competitive
  research on specific accounts, see competitor-profiling.
metadata:
  version: 1.0.0
---
...
- Invoke explicitly as `$prospecting` when desired. Product and audience context is stored in `.agents/product-marketing.md`.
- Shared implementation/tool references are under `.agents/vendor/marketingskills/tools/`. They describe options; they do not prove that a CLI, MCP server, account, credential, or network capability is configured.
- Before external actions, verify prerequisites and obtain approval for publishing, ad spend, CRM changes, outreach, submissions, or other side effects. Never invent analytics, customer evidence, competitor facts, or campaign results.
...
If `.agents/product-marketing.md` exists (or the legacy `product-marketing-context.md` filename exists), read it before asking questions. Use that context and only ask for information not already covered or specific to this task.
...
For implementation, see the [tools registry](../../vendor/marketingskills/tools/REGISTRY.md). Key prospecting tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **Apollo** | B2B / SaaS firmographic + contact discovery | - | [apollo.md](../../vendor/marketingskills/tools/integrations/apollo.md) |
| **Clay** | Multi-source enrichment + waterfall | ✓ | [clay.md](../../vendor/marketingskills/tools/integrations/clay.md) |
| **Clearbit** | Email-to-company enrichment | - | [clearbit.md](../../vendor/marketingskills/tools/integrations/clearbit.md) |
| **ZoomInfo** | Enterprise B2B contact + intent | ✓ | [zoominfo.md](../../vendor/marketingskills/tools/integrations/zoominfo.md) |
| **Hunter** | Email pattern + verification | - | [hunter.md](../../vendor/marketingskills/tools/integrations/hunter.md) |
| **Snov** | Email finder + verifier | - | [snov.md](../../vendor/marketingskills/tools/integrations/snov.md) |
| **Truelist** | Email deliverability validation | - | [truelist.md](../../vendor/marketingskills/tools/integrations/truelist.md) |
| **Outreach** | Sales engagement (post-list) | ✓ | [outreach.md](../../vendor/marketingskills/tools/integrations/outreach.md) |
| **RB2B** | Visitor identification (warm intent) | - | [rb2b.md](../../vendor/marketingskills/tools/integrations/rb2b.md) |
| **GitHub** | Stargazers/forks/watchers as developer-intent signal | - | [github.md](../../vendor/marketingskills/tools/integrations/github.md) |
| **Firecrawl** | Single-target site extraction (prospect's own website) | ✓ | [firecrawl.md](../../vendor/marketingskills/tools/integrations/firecrawl.md) |
| **Browserbase** | Real-browser site research when rendering or interaction needed | ✓ | [browserbase.md](../../vendor/marketingskills/tools/integrations/browserbase.md) |
