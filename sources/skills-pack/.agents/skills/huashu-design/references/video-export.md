...
```bash
node .agents/skills/huashu-design/scripts/render-video.js <html文件>
```
...
```bash
bash .agents/skills/huashu-design/scripts/convert-formats.sh <input.mp4> [gif_width] [--minterpolate]
```
...
```bash
node .agents/skills/huashu-design/scripts/render-video-seek.js <html文件> --fps=60
```
