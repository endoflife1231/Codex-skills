...
metadata:
  ...
  source_path: skills/.curated/claude-main/.claude/skills/skill-auditor/SKILL.md
---
...
List all skills in the `.agents/skills/` directory:
...
```bash
python .agents/skills/skill-auditor/scripts/audit_skills.py .agents/skills/
```
...
```bash
python .agents/skills/skill-auditor/scripts/audit_skills.py .agents/skills/ --fix
```
