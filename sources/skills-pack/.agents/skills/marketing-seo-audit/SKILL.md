...
description: Run a practical marketing-oriented SEO review covering crawlability, on-page basics, content, links,
  and prioritized recommendations without requiring the full Codex SEO Suite runtime. Use for a lightweight/manual audit;
  use `$seo-audit` for deep crawls, specialist analysis, scripts, and optional live integrations.
metadata:
  version: 2.0.0
---
...
- Invoke explicitly as `$marketing-seo-audit` when desired. Product and audience context is stored in `.agents/product-marketing.md`.
