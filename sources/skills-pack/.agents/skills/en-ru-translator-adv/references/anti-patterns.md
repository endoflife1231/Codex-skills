...
| организовать вызов Codex | вызвать Codex |
...
When the work context is already clear (e.g., working in Codex), avoid re-stating it:

| Bad | Good |
|-----|------|
| нашли корневую причину в коде проекта (при работе в Codex) | нашли корневую причину |
