...
# Website image direction

> Codex adaptation: This mode produces section references, not implementation code. Use `$imagegen`; generate the number of images justified by the brief rather than treating upstream quantities as unconditional. Use heading search to navigate this long reference.
