...
# Core anti-slop frontend reference

> Codex adaptation: The parent `SKILL.md` controls scope and workflow. Treat absolute bans below as diagnostic pressure, not permission to override an existing design system, user request, accessibility requirement, or verified project convention. Use heading search to navigate this long reference and load only the relevant section.
