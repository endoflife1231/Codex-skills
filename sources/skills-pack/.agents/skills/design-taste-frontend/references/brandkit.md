...
# Brand-kit image direction

> Codex adaptation: Use only for a requested brand-kit or identity-board artifact. Follow `$imagegen` for actual generation, preserve verified brand assets, and do not imitate a living designer's exact style. Use heading search to navigate this reference.
