---
name: seo-flow
description: 'FLOW framework integration — evidence-led SEO using the Find → Leverage → Optimize → Win loop. Surfaces
  stage-specific AI prompts from the FLOW knowledge base (41 prompts, CC BY 4.0). Use when user says "FLOW", "FLOW
  framework", "seo flow", "evidence-led SEO", "find leverage optimize win", or wants stage-specific SEO prompts.
...
FLOW is an evidence-led SEO operating model built for the AI-search era. Codex SEO Suite
...
### On `$seo-flow sync`
1. Run: `python3 .agents/vendor/claude-seo/scripts/sync_flow.py`
