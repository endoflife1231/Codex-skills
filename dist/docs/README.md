...
- `skills/`: 249 license-audited, installable skills
...
- `licenses/`: third-party notices and audit evidence

Repository-level release tooling is in `release/`. Public packages intentionally exclude the five skills whose redistribution permission could not be confirmed. See `../../OPEN_SOURCE_AUDIT.md`.
