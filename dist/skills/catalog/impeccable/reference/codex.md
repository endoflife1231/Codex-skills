...
Raster ingredients identified in Step E need clean production assets. With explicit user permission, use the project agent `impeccable_asset_producer`; otherwise produce them inline in the parent session.
