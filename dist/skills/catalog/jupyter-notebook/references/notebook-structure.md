...
Prefer scaffolding from the bundled templates or `new_notebook.py` (for example, `$HOME/.agents/skills/jupyter-notebook/scripts/new_notebook.py`) instead of hand-authoring raw notebook JSON.
