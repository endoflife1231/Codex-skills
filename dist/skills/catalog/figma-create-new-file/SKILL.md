...
description: Create a new blank Figma file. Use when the user wants to create a new Figma design or FigJam file, or when you need a new file before calling use_figma. Handles plan resolution via whoami if needed.
metadata:
  codex_migration: '2026-06-27'
  source_path: skills/.curated/figma-create-new-file/SKILL.md
---
...
This skill accepts optional arguments: `$figma-create-new-file with optional `editorType` and `fileName` in the request`
...
- `$figma-create-new-file — create a FigJam file named “My Whiteboard”` — creates a FigJam file named "My Whiteboard"
- `$figma-create-new-file — create a design file named “My New Design”` — creates a design file named "My New Design"
