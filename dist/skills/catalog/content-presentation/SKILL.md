...
description: Generate full HTML presentations using Slidev, Reveal.js, Spectacle, or raw HTML with brand integration.
  Use when user wants to create a presentation, slide deck, pitch deck, conference talk, workshop materials, keynote,
  sales deck, or client proposal slides. Even if user just says "slides" or "deck", use this skill.
---
...
- `.agents/brand/BRAND.md` -- identity, audience, differentiators
- `.agents/brand/VISUAL.md` -- colors, fonts, logo rules
- `.agents/brand/VOICE.md` -- tone, vocabulary, anti-patterns

If `.agents/brand/` is missing, ask the user for basic color, font, and tone preferences before proceeding. Do not generate a deck with default blue-and-white styling.
...
See `brand-integration.md` for the full mapping from `.agents/brand/VISUAL.md` to presentation CSS.
...
- If the .agents/brand/ directory is missing, offer to proceed with user-specified colors/fonts or to run content-setup first.
