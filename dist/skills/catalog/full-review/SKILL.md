...
metadata:
  ...
  source_path: skills/.curated/claude-main/.claude/skills/full-review/SKILL.md
---
...
- `$full-review` — comprehensive review of all changes
- For a fast pass, invoke `$full-review` and explicitly limit scope to critical blockers
