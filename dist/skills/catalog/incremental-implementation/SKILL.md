...
description: Implement multi-file changes as small vertical slices with checkpoints
  and verification after each slice. Use when a task is too large for one safe edit.
metadata:
