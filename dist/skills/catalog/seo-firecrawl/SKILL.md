---
name: seo-firecrawl
description: 'Full-site crawling, scraping, and site mapping via Firecrawl MCP. Use when user says "crawl site",
  "map site", "full crawl", "find all pages", "broken links", "site structure", "discover pages", "JS rendering",
  or needs site-wide analysis.
...
# Firecrawl Extension for Codex SEO Suite
...
This skill requires the optional Firecrawl MCP server. Follow `references/FIRECRAWL-SETUP.md` before live calls.
...
|-------|-------|-----------|
| `FIRECRAWL_API_KEY not set` | MCP not configured | Read `references/FIRECRAWL-SETUP.md` |
...
3. Install Firecrawl: `references/FIRECRAWL-SETUP.md`
