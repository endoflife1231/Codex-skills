...
description: Generate SVG and HTML infographics with brand-aware design. Use when user wants to create an infographic,
  data visualization, process flow, comparison chart, stat card, or visual data summary.
---
...
- `.agents/brand/BRAND.md` -- identity, audience (affects visual tone)
...
If `.agents/brand/` is missing, ask for 2-3 colors and proceed with a clean default style.
...
- If .agents/brand/ is missing, proceed with a clean minimal style and note that running content-setup would improve consistency.
