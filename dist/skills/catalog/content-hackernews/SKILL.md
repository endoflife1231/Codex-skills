...
description: Hacker News post generation for Show HN, Ask HN, and submissions. Use when user wants to post to Hacker
  News or write a Show HN/Ask HN post.
---
...
3. **Check for brand voice**: Read `.agents/brand/VOICE.md` if it exists, then heavily adapt it using `hn-voice.md`. HN has the strictest voice requirements of any platform. Marketing language of any kind will get the post flagged, downvoted, or ignored.
