...
metadata:
  ...
  source_path: skills/.curated/brand/SKILL.md
---
...
Infer the requested operation from the user message. For an update, read `references/update.md`; otherwise load only the reference matching the requested brand task. Resolve bundled scripts from `.agents/skills/brand/scripts/`.
