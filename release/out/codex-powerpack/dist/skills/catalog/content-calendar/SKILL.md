...
description: Editorial calendar planning and content scheduling. Use when user wants to plan a content calendar,
  create a publishing schedule, organize content across platforms, or plan a content series.
---
...
1. **Check for brand context**: Read `.agents/brand/VOICE.md` if it exists. Calendar planning should align content themes with brand pillars. If the user has already run the content-strategy skill, reference the content pillars and briefs from that output.
...
- **Pillars**: What content pillars exist? Reference `.agents/brand/BRAND.md` or the output of the content-strategy skill if available. If no pillars are defined, suggest 3-5 based on the user's context.
...
| Need | Skill |
|---|---|
| Define content pillars | `$content-editorial-strategy` |
