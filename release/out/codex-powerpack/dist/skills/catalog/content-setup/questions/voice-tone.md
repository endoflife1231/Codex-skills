...
- The `$content-setup (voice calibration)` command will analyze these in detail.

**If no:**
- "That's fine. We'll build your voice from the answers you've given. You can always add samples later and run `$content-setup (voice calibration)` to refine."
