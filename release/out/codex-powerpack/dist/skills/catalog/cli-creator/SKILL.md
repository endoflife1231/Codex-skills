...
metadata:
  ...
  source_path: skills/.curated/cli-creator/SKILL.md
---
...
After the CLI works, create or update a small skill for it. Use `$skill-creator` when it is available. Use `$HOME/.agents/skills/<tool-name>/SKILL.md` for a personal companion skill unless the user names a repo-local `.agents/skills/...` path or another skill repo.
