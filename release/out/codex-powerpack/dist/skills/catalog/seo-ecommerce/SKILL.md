---
name: seo-ecommerce
description: 'E-commerce SEO analysis: Google Shopping visibility, Amazon marketplace intelligence, product schema
  validation, competitor pricing analysis, and marketplace keyword gaps. Combines on-page product SEO with marketplace
  data from DataForSEO Merchant API. Use when user says "ecommerce SEO", "product SEO", "Google Shopping", "marketplace
  SEO", "product schema", "Amazon SEO", "product listings", "shopping ads", or "merchant SEO".
...
```
1. python3 .agents/vendor/claude-seo/scripts/render_page.py <url> --mode auto → raw/rendered HTML
2. python3 .agents/vendor/claude-seo/scripts/parse_html.py --url <url>   → SEO elements
...
```bash
python3 .agents/vendor/claude-seo/scripts/dataforseo_costs.py check merchant_google_products_search
```
...
After each call:
```bash
python3 .agents/vendor/claude-seo/scripts/dataforseo_costs.py log merchant_google_products_search <cost>
```
...
python3 .agents/vendor/claude-seo/scripts/dataforseo_merchant.py search "<keyword>" --marketplace google

# Seller analysis: merchant ratings and dominance
python3 .agents/vendor/claude-seo/scripts/dataforseo_merchant.py sellers "<keyword>"

# Normalize results for analysis
python3 .agents/vendor/claude-seo/scripts/dataforseo_normalize.py results.json --module merchant
```
...
```bash
python3 .agents/vendor/claude-seo/scripts/dataforseo_costs.py check merchant_amazon_products_search
```
...
python3 .agents/vendor/claude-seo/scripts/dataforseo_merchant.py search "<keyword>" --marketplace amazon

# Cross-marketplace comparison
python3 .agents/vendor/claude-seo/scripts/dataforseo_merchant.py compare "<keyword>"
```
...
python3 .agents/vendor/claude-seo/scripts/ucp_check.py https://store.example.com --json

# With endpoint reachability probes (HEAD each declared capability)
python3 .agents/vendor/claude-seo/scripts/ucp_check.py https://store.example.com --probe-endpoints --json
```
