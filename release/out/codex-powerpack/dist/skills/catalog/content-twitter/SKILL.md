...
description: X/Twitter thread and single tweet generation with brand voice and hook-first writing. Use when user
  wants to create a tweet, thread, X post, or Twitter content.
---
...
1. **Check for brand voice**: Read `.agents/brand/VOICE.md` if it exists. Adapt the brand voice for X's more informal, direct tone. If no voice file exists, default to conversational, direct, and personality-forward.
