---
name: interview-me
description: Clarify an underspecified request through focused one-question-at-a-time
  discovery until intent, users, constraints, and success criteria are clear.
metadata:
...
This skill needs a live, responsive user. **Do not invoke in non-interactive contexts** like CI pipelines, scheduled runs, `an autonomous loop`, or autonomous-loop. If you're in one of those and the ask is underspecified, flag that as a blocker for the user instead of guessing.
