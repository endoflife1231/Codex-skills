...
Copy this file to `.agents/listening-sources.md` in your project`) and fill in the brackets. Codex reads it when running the [listening workflow](listening.md).
