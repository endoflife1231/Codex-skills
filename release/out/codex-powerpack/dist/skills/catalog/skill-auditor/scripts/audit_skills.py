...
Example:
    python audit_skills.py .agents/skills/
    python audit_skills.py .agents/skills/ --json
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    %(prog)s .agents/skills/
    %(prog)s .agents/skills/ --json
    %(prog)s .agents/skills/my-skill --single
        """
    )
