...
The following require creative input that cannot be auto-extracted. Group them into one focused user interaction:
...
Group them into one focused user interaction. Options must be concrete.
