---
name: seo-google
description: 'Google SEO APIs: Search Console (Search Analytics, URL Inspection, Sitemaps), PageSpeed Insights v5,
  CrUX field data with 25-week history, Indexing API v3, and GA4 organic traffic. Provides real Google field data
  for Core Web Vitals, indexation status, search performance, and organic traffic trends. Use when user says "search
  console", "GSC", "PageSpeed", "CrUX", "field data", "indexing API", "GA4 organic", "URL inspection", "google api
  setup", "real CWV data", "impressions", "clicks", "CTR", "position data", "LCP", "INP", "CLS", "FCP", "TTFB",
  or "Lighthouse scores".
...
```bash
python3 .agents/vendor/claude-seo/scripts/google_auth.py --check --json
```
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/pagespeed_check.py <url> --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/pagespeed_check.py <url> --crux-only --json`

### `$seo-google crux-history <url>`

25-week CrUX History trends. Shows whether CWV metrics are improving, stable, or degrading.

**Script:** `python3 .agents/vendor/claude-seo/scripts/crux_history.py <url> --json`
**Reference:** `references/pagespeed-crux-api.md`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/gsc_query.py --property <property> --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/gsc_inspect.py <url> --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/gsc_inspect.py --batch <file> --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/gsc_query.py sitemaps --property <property> --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/indexing_notify.py <url> --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/indexing_notify.py --batch <file> --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/ga4_report.py --property <id> --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/ga4_report.py --property <id> --report top-pages --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/youtube_search.py search "<query>" --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/youtube_search.py video <video_id> --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/nlp_analyze.py --url <url> --json` or `--text "..."`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/nlp_analyze.py --url <url> --features entities --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/keyword_planner.py ideas "<seed>" --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/keyword_planner.py volume "<kw1>,<kw2>" --json`
...
**Script:** `python3 .agents/vendor/claude-seo/scripts/google_report.py --type <type> --data <json> --domain <domain> --format pdf`
...
2. Save JSON output to file: `python3 .agents/vendor/claude-seo/scripts/pagespeed_check.py <url> --json > data.json`
3. Generate report: `python3 .agents/vendor/claude-seo/scripts/google_report.py --type cwv-audit --data data.json --domain <domain>`
