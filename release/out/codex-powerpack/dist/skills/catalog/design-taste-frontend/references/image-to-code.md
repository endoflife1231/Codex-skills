...
> Codex adaptation: Use `$imagegen` for image work and obtain direction approval before implementation. Keep semantic UI in code, avoid living-artist imitation, and use heading search to navigate this long reference.
