...
> Codex adaptation: This mode produces concept images, not implementation code. Use `$imagegen`, preserve platform conventions, and use heading search to navigate this long reference.
