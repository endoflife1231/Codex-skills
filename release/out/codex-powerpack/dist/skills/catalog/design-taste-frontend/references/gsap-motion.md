...
# GSAP-heavy motion direction

> Codex adaptation: Verify GSAP is already installed or obtain approval before adding it. Execute real deterministic selection when useful; never claim to have run Python or another command when it was only simulated. Accessibility and reduced-motion behavior are mandatory.
